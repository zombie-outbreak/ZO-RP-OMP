// ============================================================================
// ZOMBIE OUTBREAK ROLEPLAY - TEXTDRAWS MODULE
// ============================================================================
/*
* MODULE: Textdraws
* PURPOSE: Server-side and player-specific textdraw creation and management
* 
* DEPENDENCIES:
* - core/colors.pwn (color constants)
* - core/player_data.pwn (player textdraw arrays)
* 
* PUBLIC FUNCTIONS:
* - CreateServerTextdraws() - Creates global server textdraws (Clock, animhelper)
* - CreateDialogueTextdraw(playerid) - Creates dialogue textdraw for player
* - HideDialogueTextdraw(playerid) - Hides player's dialogue textdraw
* - ShowDialogueTextdraw(playerid) - Shows player's dialogue textdraw
* - CreatePlayerLoginTextdraws(playerid) - Creates login screen textdraws
* - DestroyPlayerLoginTextdraws(playerid) - Destroys login textdraws
* - CreateInfoBar(playerid) - Creates player info bar (ID, level, perks, exp)
* - UpdateHudElementForPlayer(playerid, element) - Updates specific HUD element
* 
* DESCRIPTION:
* Manages all textdraw elements including server clock, animation helper,
* dialogue boxes, login screens, and player HUD (info bar).
*/

// ============================================================================
// CONFIGURATION
// ============================================================================
#if !defined MODULE_TEXTDRAWS_INCLUDED
#define MODULE_TEXTDRAWS_INCLUDED
...
stock ShowDialogueTextDraw(playerid, const text[])
{
...
#endif // MODULE_TEXTDRAWS_INCLUDED